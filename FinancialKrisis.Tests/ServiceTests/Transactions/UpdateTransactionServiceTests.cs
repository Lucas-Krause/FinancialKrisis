...
public class UpdateTransactionServiceTests
{
    ...
    //    await ExceptionAssert.AssertApplicationRuleException<Category>(() => updateScenario.UpdateAsync(transaction.Id), ApplicationRuleErrorCode.EntityInactive);
    //}
    ...
    //    await ExceptionAssert.AssertApplicationRuleException<Subcategory>(() => updateScenario.UpdateAsync(transaction.Id), ApplicationRuleErrorCode.EntityInactive);
    //}
    ...
    //    await ExceptionAssert.AssertApplicationRuleException<Payee>(() => updateScenario.UpdateAsync(transaction.Id), ApplicationRuleErrorCode.EntityInactive);
    //}
}
